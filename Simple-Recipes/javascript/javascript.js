...
// Sets up the button tath will open the recipe modal
...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        //Overrides the default browser refresh triggered by hitting submit
        ...
        //Email checks for all the symbols that would be needed for an 
        //email address such as @ and . and text around them.
        ...
        if (!firstName || !lastName || !phone || !message) {
            //Checks if fields have been filed out.
        ...
        //This displays what the user wrote to console.
